...
public class Server implements ActionListener{
    ...
    Server(){
       ...
       ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("project1/icon/army.png"));
       Image i5 = i4.getImage().getScaledInstance(60, 60, Image.SCALE_DEFAULT);
       ImageIcon i6 = new ImageIcon(i5);
       JLabel l2 = new JLabel(i6);
       l2.setBounds(50, 10, 60, 60);
       p1.add(l2);
       ...
       JLabel l3 = new JLabel("General");
       l3.setFont(new Font("SAN_SERIF", Font.BOLD, 19));
       l3.setForeground(Color.WHITE);
       l3.setBounds(120, 15, 110, 20);
       p1.add(l3);   
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            String out = t1.getText();
           // a1.setToolTipText(a1.getToolkit()+"\n"+out);
           t1.setText("");
            JPanel p2 = formatLabel(out);
